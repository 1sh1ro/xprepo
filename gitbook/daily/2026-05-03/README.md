...
样本口径：按 30d PnL 排序的 Top10 交易员，抓取其当前持仓明细（共 30 条仓位）。

### 当前持仓集中度
| 合约 | 多头名义仓位 | 空头名义仓位 | 净敞口 | 多头笔数 | 空头笔数 |
|---|---:|---:|---:|---:|---:|
| ETH-USDT-SWAP | $29.68M | $0 | $29.68M (净多) | 3 | 0 |
| BTC-USDT-SWAP | $27.81M | $0 | $27.81M (净多) | 5 | 0 |
| BTC-USD-260626 | $22.50M | $0 | $22.50M (净多) | 1 | 0 |
| BTC-USD-SWAP | $10.61M | $0 | $10.61M (净多) | 4 | 0 |
| XRP-USDT-SWAP | $3.34M | $0 | $3.34M (净多) | 2 | 0 |
| BTC-USD-260925 | $2.61M | $0 | $2.61M (净多) | 1 | 0 |
| SOL-USDT-SWAP | $2.52M | $0 | $2.52M (净多) | 2 | 0 |
| ETH-USD-SWAP | $1.30M | $0 | $1.30M (净多) | 1 | 0 |
| ETH-USD-260626 | $402,940 | $0 | $402,940 (净多) | 1 | 0 |
| ETH-USD-260925 | $394,260 | $0 | $394,260 (净多) | 1 | 0 |
| DOGE-USDT-SWAP | $379,834 | $0 | $379,834 (净多) | 1 | 0 |
| XAU-USDT-SWAP | $369,855 | $0 | $369,855 (净多) | 2 | 0 |

### 结构解读（仓位视角）
- 主仓位集中在 `ETH-USDT-SWAP, BTC-USDT-SWAP, BTC-USD-260626`，说明聪明钱当前主要风险预算仍在 BTC/ETH 主线。
- 本次样本中净敞口整体偏多（空头名义仓位很低），短线交易逻辑更偏“顺势做多 + 回撤管理”。
- 仍有向 XRP/SOL 等高 beta 品种扩展的迹象，但体量显著小于 BTC/ETH，属于卫星仓位。

### 动向 -> 含义 -> 观察点
1. 动向：BTC/ETH 合约占据绝大部分名义仓位。
含义：资金在方向上偏一致，市场叙事仍由主流币驱动。
观察点：若 BTC/ETH 净多敞口开始下降且成交放大，通常是减仓或对冲启动信号。

2. 动向：样本内空头敞口明显不足。
含义：当前更像“进攻态仓位结构”，对突发利空更敏感。
观察点：盯住 funding 从中性转负、且 DVOL 抬升的共振，若出现则防守优先级上升。

3. 动向：非主流标的（如 XRP/SOL）有仓位但占比次要。
含义：风格扩散存在，但还没到全面 risk-on 阶段。
观察点：若高 beta 仓位占比连续两天提升，同时 Top10 外占比上行，才算扩散确认。

交易含义：聪明钱仓位信号适合用于“方向偏好与仓位强度”监控，不建议脱离成交/波动/主导率单独使用。
