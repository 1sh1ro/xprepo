...
## RWA 结构观察
RWA 资产类别快照暂不可用（见 Data Gaps）。

## 非 DeFi（交易所期现）
非 DeFi 期现样本暂不可用（见 Data Gaps）。

## 市场脉冲
![全市场当日水平](charts/chart_market_snapshot_levels.png)

截至 2026-07-21，全市场市值 N/A，24h 成交额 N/A，BTC 主导率 N/A。
...
- Binance 非DeFi期现数据获取失败 BTC: <urlopen error [Errno 1] Operation not permitted>
- Binance 非DeFi期现数据获取失败 ETH: <urlopen error [Errno 1] Operation not permitted>
- OKX 非DeFi期现数据获取失败 BTC: <urlopen error [Errno 1] Operation not permitted>
- OKX 非DeFi期现数据获取失败 ETH: <urlopen error [Errno 1] Operation not permitted>
- 非DeFi期现数据为空：未获取到 Binance/OKX 的可用样本。
- 借币成本多源数据获取失败: Binance: <urlopen error [Errno 1] Operation not permitted> | OKX: <urlopen error [Errno 1] Operation not permitted> | Bybit: <urlopen error [Errno 1] Operation not permitted> | Backpack: <urlopen error [Errno 1] Operation not permitted>
- DefiLlama 稳定币收益数据获取失败: <urlopen error [Errno 1] Operation not permitted>
- DefiLlama 扩展稳定币样本获取失败: <urlopen error [Errno 1] Operation not permitted>
- Bitcompare CeFi 利率获取失败: <urlopen error [Errno 1] Operation not permitted>
- RWA.xyz U.S. Treasuries 快照获取失败: <urlopen error [Errno 1] Operation not permitted>
- RWA.xyz Credit 快照获取失败: <urlopen error [Errno 1] Operation not permitted>
- RWA.xyz Tokenized Stocks 快照获取失败: <urlopen error [Errno 1] Operation not permitted>
- RWA.xyz Non-U.S. Government Debt 快照获取失败: <urlopen error [Errno 1] Operation not permitted>
- RWA.xyz Active Strategies 快照获取失败: <urlopen error [Errno 1] Operation not permitted>
- RWA.xyz Real Estate 快照获取失败: <urlopen error [Errno 1] Operation not permitted>
- RWA 资产类别快照为空：RWA.xyz 公开页未返回可解析数据。
- OKX 聪明钱数据获取失败（traders）: Update available for @okx_ai/okx-trade-cli: 1.3.2 → 1.3.9
Run: npm install -g @okx_ai/okx-trade-cli

Error: Not logged in — run `okx-auth login` first
