...
交易所成交方面，多数平台样本成交回升，但盘口深度、报价连续性与滑点尚未验证，不能直接等同于流动性改善。杠杆方面，当前资金费率未显示极端拥挤，但单一平台样本不足以概括整体杠杆状态。期权定价方面，DVOL 处于相对低位，但单凭该指标仍不足以判断期权保护成本是否处于低估区间；情绪方面，情绪与价格修复节奏尚未完全同步。几项指标共同用于确认市场状态，但暂不足以归因于特定事件。
...
- 简评：BTC 与 ETH 同步偏强，短线价格仍偏上方，但延续性仍需成交确认。
...
2. 若衍生品占比继续上升而 Funding 仍中性，只能确认成交结构进一步偏向衍生品；是否放大波动仍需结合 DVOL、强平和成交验证。
