#!/usr/bin/env python3
"""Configurable altFINS HTTP client."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Call altFINS API")
    parser.add_argument("path", help="Endpoint path, e.g. /health")
    parser.add_argument("--method", choices=["GET", "POST"], default="GET")
    parser.add_argument("--base-url", default=os.environ.get("ALTFINS_BASE_URL", "https://api.altfins.com"))
    ...
    api_key = os.environ.get("ALTFINS_API_KEY")
    if not api_key:
        print("ALTFINS_API_KEY is required", file=sys.stderr)
        return 2

    api_key_header = os.environ.get("ALTFINS_API_KEY_HEADER", "x-api-key")
