#!/usr/bin/env python3
"""Configurable Coinfeeds HTTP client."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Call Coinfeeds API")
    parser.add_argument("path", help="Endpoint path, e.g. /v1/news")
    parser.add_argument("--method", choices=["GET", "POST"], default="GET")
    parser.add_argument("--base-url", default=os.environ.get("COINFEEDS_BASE_URL", "https://api.coinfeeds.io"))
    ...
    api_key = os.environ.get("COINFEEDS_API_KEY")
    if not api_key:
        print("COINFEEDS_API_KEY is required", file=sys.stderr)
        return 2

    api_key_header = os.environ.get("COINFEEDS_API_KEY_HEADER", "x-api-key")
    ...
    headers = {
        ...
        "User-Agent": "coinfeeds-skill/1.0",
