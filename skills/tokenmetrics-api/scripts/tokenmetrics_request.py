#!/usr/bin/env python3
"""Configurable Token Metrics HTTP client."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Call Token Metrics API")
    parser.add_argument("path", help="Endpoint path, e.g. /v2/indices")
    parser.add_argument("--method", choices=["GET", "POST"], default="GET")
    parser.add_argument("--base-url", default=os.environ.get("TOKENMETRICS_BASE_URL", "https://api.tokenmetrics.com"))
    ...
    api_key = os.environ.get("TOKENMETRICS_API_KEY")
    if not api_key:
        print("TOKENMETRICS_API_KEY is required", file=sys.stderr)
        return 2

    api_key_header = os.environ.get("TOKENMETRICS_API_KEY_HEADER", "x-api-key")
    ...
    headers = {
        ...
        "User-Agent": "tokenmetrics-skill/1.0",
